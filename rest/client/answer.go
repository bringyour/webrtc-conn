...
func Answer(
	...
	eg.Go(func() (err error) {
		...
		err = co.longPoll(egCtx, "/offer/sdp", requestHeader, nil, &offer)
		if err != nil {
	...
	eg.Go(func() (err error) {
		...
		err = co.put(answerContext, "/answer/sdp", requestHeader, string(d))
		if err != nil {
	...
	eg.Go(func() (err error) {
		...
		for {
			...
			err = co.post(answerContext, "/answer/peer_candidates", requestHeader, string(d))
			if err != nil {
